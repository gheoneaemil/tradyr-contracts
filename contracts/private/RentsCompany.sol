...
contract RENTSCOMPANY is BMarketGiveItemHandler {
        ...
        if ( companyValidation ) {
            ...
            if ( itemIntact ) {
                ...
                if ( referrer == address(0) ) {
                    users.userDeposit(rents[rent].owner,rents[rent].fee - rents[rent].fee / theFees[0] );
                } else {
                    uint partnerFee = users.getPartnerFee(referrer);
                    users.userDeposit(referrer,rents[rent].fee / partnerFee );
                    users.userDeposit(rents[rent].owner,rents[rent].fee - rents[rent].fee / theFees[0] - rents[rent].fee / partnerFee);
                }
                ...
                if ( referrer == address(0) ) {
                    users.userDeposit(rents[rent].owner,rents[rent].price - rents[rent].price / theFees[0] );
                } else {
                    uint partnerFee = users.getPartnerFee(referrer);
                    users.userDeposit(referrer,rents[rent].price - rents[rent].price / partnerFee );
                    users.userDeposit(rents[rent].owner,rents[rent].price - rents[rent].price / partnerFee - rents[rent].price / theFees[0] );
                }
